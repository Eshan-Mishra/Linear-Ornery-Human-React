          ...
          <div className="navbar8-buttons1">
            ...
            <button className="navbar8-action21 thq-button-outline thq-button-animated">
              <span className="thq-body-small">
                {props.action2 ?? (
                  <Fragment>
                    <span className="navbar8-text19">Join Now</span>
                  </Fragment>
                )}
              </span>
            </button>
...
Navbar8.defaultProps = {
  ...
  page4ImageSrc:
    'https://images.unsplash.com/photo-1706720094778-5156e8b656e2?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTcyNjI2MDQ1MHw&ixlib=rb-4.0.3&q=80&w=1080',
  ...
  action2: undefined,
  page1ImageSrc:
    'https://images.unsplash.com/photo-1601388499335-3f31452e7718?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTcyNjI2MDQ1MHw&ixlib=rb-4.0.3&q=80&w=1080',
  ...
  page2ImageSrc:
    'https://images.unsplash.com/photo-1707297143095-fc7651294bba?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTcyNjI2MDQ1MHw&ixlib=rb-4.0.3&q=80&w=1080',
  logoAlt: 'Flea Market Logo',
  link4: undefined,
  action1: undefined,
  page2Description: undefined,
  page1ImageAlt: 'Home Image',
  page4ImageAlt: 'Register Image',
  page1: undefined,
  page3ImageAlt: 'Contact Image',
  linkUrlPage1: 'https://www.teleporthq.io',
  page3: undefined,
  page3ImageSrc:
    'https://images.unsplash.com/photo-1649770637676-814780c7b252?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTcyNjI2MDQ1MXw&ixlib=rb-4.0.3&q=80&w=1080',
